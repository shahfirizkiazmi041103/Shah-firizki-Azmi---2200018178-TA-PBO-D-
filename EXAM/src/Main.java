...
class OnlineTest extends JFrame implements ActionListener
{
    ...
    {
        super(s);
        getContentPane().setBackground(new Color(204, 169, 221));
        l=new JLabel();
        add(l);
        bg=new ButtonGroup();
        for(int i=0;i<5;i++)
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getActionCommand().equals("Result"))
        {
            ...
            JOptionPane.showMessageDialog(this,"Total benar="+count);
            JOptionPane.showMessageDialog(this,"Poin yang didapatkan="+count*5);
            System.exit(0);
        }
    }
    void set() {
        ...
        if (current == 19) {
            l.setText(" Soal 20 : Planet mana yang merupakan planet terdekat dengan Matahari di dalam Sistem Tata Surya?");
            jb[0].setText("Venus");
            jb[1].setText("Mars");
